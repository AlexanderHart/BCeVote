...
@user_blueprint.route('/createPetition', methods=['GET', 'POST'])
@login_required
@check_confirmed
def createPetition():
    ...
    if form.validate_on_submit():
        ...
        acl = algod.AlgodClient("44018d81c65b1b2fc4c33380cc9bb3cd0e6c33f8ede8bbee63638943f819b003", "http://127.0.0.1:45291")
    ...
    return render_template('user/createPetition.html', form=form)

@user_blueprint.route('/listPetitions', methods=['GET', 'POST'])
@login_required
@check_confirmed
def listPetitions():
    return render_template('user/listPetitions.html')
